...
const SendToken = () => {
    ...
    async function handleSendToken() {
        ...
        const tx = new Transaction({ initiator: wallet }).sendLovelace(address, amount);
        ...
        if (txHash) {
            ...
            setTransactionSuccessMsg(`Send token successfully. Transaction Hash: ${txHash}`);
        }
    }
        ...
        <>
            {connected && (
                ...
                >
                    ...
                    />
                    <button onClick={handleSendToken} style={{ height: '40px', width: '100px' }}>
                        Send token
                    </button>
